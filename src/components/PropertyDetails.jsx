...
export default function PropertyDetails() {
  ...
  // Standardized prototype property ID
  ...
  return (
    <>
        ...
        <div className="flex items-start justify-between pb-2.5 border-b border-cipher-border">
          <div>
            <button
              ...
              className="flex items-center gap-1 text-[11px] font-bold text-cipher-govblue hover:underline mb-1 cursor-pointer"
            >
        ...
        <div className="p-3 rounded-xl bg-slate-50 border border-cipher-border space-y-2.5">
          ...
          <div>
            ...
            <div className="flex items-center justify-between gap-1">
              ...
              <button
                ...
                className="shrink-0 p-1 rounded hover:bg-white text-cipher-muted hover:text-cipher-navy transition-all cursor-pointer"
                title="Copy 2D ULPIN"
              >
            ...
            <div className="pt-2 border-t border-cipher-borderLight">
              ...
              <div className="flex items-center justify-between gap-1 bg-blue-50/80 p-2 rounded-lg border border-blue-200/80">
                ...
                <button
                  ...
                  className="shrink-0 p-1 rounded bg-white text-cipher-govblue hover:bg-blue-100 transition-all shadow-2xs cursor-pointer"
                  title="Copy 3D ULPIN"
                >
          ...
          <div className="pt-2 border-t border-cipher-borderLight">
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 py-2 px-3 rounded-lg bg-cipher-govblue hover:bg-cipher-navy text-white text-xs font-bold shadow-subtle transition-all cursor-pointer"
            >
              <ShieldCheck size={14} className="text-emerald-300" />
              <span>3D Spatial Certificate &amp; Hash</span>
            </button>
          </div>
        </div>
        ...
        {selectedRoom ? (
                ...
                <div className="space-y-1.5">
                  {stackInfo.above && (
                    <button
                      ...
                      className="w-full flex items-center justify-between p-2 rounded-lg bg-white border border-slate-200 hover:border-cipher-govblue text-left transition-all text-xs cursor-pointer"
                    >
                      <div className="flex items-center gap-1.5">
          ...
          <div>
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
              <button
                onClick={() => setCurrentPage('drone-imagery')}
                className="p-2 rounded-lg bg-blue-50 border border-blue-200 hover:bg-blue-100 flex items-center gap-1.5 font-bold text-cipher-govblue transition-all cursor-pointer"
              >
                <Satellite size={13} />
                <span>Drone Imagery</span>
              </button>
              <button
                onClick={() => setCurrentPage('lidar-pointcloud')}
                className="p-2 rounded-lg bg-cyan-50 border border-cyan-200 hover:bg-cyan-100 flex items-center gap-1.5 font-bold text-cyan-800 transition-all cursor-pointer"
              >
                <Cpu size={13} />
      ...
      {/* Spatial Identity Certificate Modal */}
