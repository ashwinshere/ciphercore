  ...
  return (
    <group ref={groupRef} position={[0, explodedOffset, 0]}>
      <group position={[0, floor.elevation, 0]}>
        ...
        <mesh position={[0, -0.1, 0]} receiveShadow castShadow={!isDimmed} raycast={noRaycast}>
        ...
        {!wireframeMode && (
          <mesh position={[0, 0.01, 0]} receiveShadow raycast={noRaycast}>
        ...
        {!wireframeMode && (
          <mesh position={[0, -0.05, 0]} raycast={noRaycast}>
        ...
        {isTopFloor && !wireframeMode && (
          <group position={[0, floorHeight, 0]}>
            ...
            <mesh position={[0, 0.45, (depth + 0.2) / 2]} raycast={noRaycast}>
            ...
            <mesh position={[(width + 0.2) / 2, 0.45, 0]} raycast={noRaycast}>
            ...
            <mesh position={[width / 2 - 8, 1.2, 0]} castShadow receiveShadow raycast={noRaycast}>
